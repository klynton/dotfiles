" Vim color file
" Converted from Textmate theme Coal Graal using Coloration v0.3.2 (http://github.com/sickill/coloration)
...
let g:colors_name = "coalgraal"

hi Cursor ctermfg=NONE ctermbg=188 cterm=NONE guifg=NONE guibg=#d8d9d1 gui=NONE
...
hi MatchParen ctermfg=146 ctermbg=NONE cterm=NONE guifg=#a3aad8 guibg=NONE gui=NONE
...
hi IncSearch ctermfg=NONE ctermbg=59 cterm=NONE guifg=NONE guibg=#4d4f5e gui=NONE
hi Search ctermfg=NONE ctermbg=59 cterm=NONE guifg=NONE guibg=#4d4f5e gui=NONE
